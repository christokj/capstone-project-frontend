        ...
        <>
            <div className=" container ps-2 py-5 flex flex-nowrap z-10 items-center justify-between ">
                <NavLink to={"/"} className="flex items-center">
                    ...
                    <h3 className="text-2xl font-bold text-dark-grey-900">TrendiQ</h3>
                </NavLink>
                ...
                <div className="items-center gap-2 flex -me-10">
                    ...
                    <DarkMode />
                    <NavLink to={"/login"} type="button" className=" text-nowrap mt-2 text-dark-grey-900  bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
                        Login
                    </NavLink>
                </div>
            </div>
